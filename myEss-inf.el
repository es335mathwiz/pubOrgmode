...
(defun inferior-ess-send-input ()
  ...
  (interactive)
(message "inferior-ess-send-input")
(print (get-buffer-process (current-buffer)))
(message "buffer process")
(print  (current-buffer))
(message "current buffer")
(message "about to run input hook")
(print ess-send-input-hook)
  (run-hooks 'ess-send-input-hook)
(print (get-buffer-process (current-buffer)))
(message "buffer process")
(print  (current-buffer))
(message "current buffer")
(message "p done out to run input hook")
  ...
  ;;       (comint-send-input))))
(message "about to comint")
  (comint-send-input)
(message "bacd from send to comint")
